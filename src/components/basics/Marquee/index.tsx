...
const Marquee = (props: MarqueeProps, ref: Ref<MarqueeHandles>): JSX.Element => {
  const {
    style,
    marqueeOnStart = true,
    speed = 1,
  ...
  const styles = useThemedStyle(_style);
...
const _style = {
  ...
  captain: {
    color: 'typography.captain.color',
    fontSize: 'typography.captain.font-size',
    fontWeight: 'typography.captain.font-weight',
    fontFamily: 'typography.captain.font-family',
    lineHeight: 'typography.captain.line-height',
  },
};

export default React.forwardRef(Marquee);
