...
import { initialState } from 'store/NetWorth/reducer';

export const makeSelectDomain = state => state.netWorth || initialState;
...
export const selectNetWorth = createSelector(makeSelectDomain, state => {
...
export const selectChartData = createSelector(makeSelectDomain, state => {
  ...
  return getLineChartGraph(chartTime, state.netWorth);
});

export const selectChartDataHomeScreen = createSelector(makeSelectDomain, state => {
  return getLineChartGraph('Y', state.netWorth);
});
