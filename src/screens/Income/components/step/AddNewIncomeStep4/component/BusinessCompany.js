...
const formatFormJson = require('assets/forms/layouts/create_business_company.json');
...
export default compose(withTranslation(), withDynamicModuleLoader(getModule()))(BusinessCompany);
