...
const formatFormJson = require('assets/forms/layouts/investments/asset-add-investment2.json');
      ...
      const incomeData =
        formData.income === ''
          ...
          : {
              ...
              type: Constants.IncomeType.InvestmentIncome,
              ...
              property: Constants.newObjectIDForTypes.Investment,
