...
import { initialState } from 'store/AssetPosition/reducer';

export const makeSelectDomain = state => state.assetPosition || initialState;
...
export const selectAssetPosition = createSelector(makeSelectDomain, state => {
...
export const selectChartData = createSelector(makeSelectDomain, state => {
  ...
  return getLineChartGraph(chartTime, state.assetPosition);
});

export const selectChartDataHomeScreen = createSelector(makeSelectDomain, state => {
  return getLineChartGraph('Y', state.assetPosition);
});
