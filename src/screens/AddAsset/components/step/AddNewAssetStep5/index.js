...
function AddNewAssetStep5(props) {
      ...
      <KeyboardAwareFlatList
        ...
        ListHeaderComponent={
          <View style={AppStyle.marginTop20}>
            ...
            <Question
              emotion="smile"
              content={t(`${i18nScope}.optiHelpDetails`, {
                name: assetType === Investments ? t(`${i18nScope}.investment`) : assetType,
              })}
            />
            {renderForm}
          </View>
...
export default compose(withTranslation())(AddNewAssetStep5);
