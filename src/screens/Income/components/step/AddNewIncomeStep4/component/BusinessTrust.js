...
const formatFormJson = require('assets/forms/layouts/create_business_trust.json');
...
export default compose(withTranslation(), withDynamicModuleLoader(getModule()))(BusinessTrust);
