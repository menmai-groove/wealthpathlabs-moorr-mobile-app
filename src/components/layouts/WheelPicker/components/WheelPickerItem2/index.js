...
const i18nScope = 'components.wheelPickerItem2';

function WheelPickerItem2({ item, isCenter, itemSize = 50, size = 100 }) {
...
export default WheelPickerItem2;
